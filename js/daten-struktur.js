...
window.STRUKTUR = {
  ...
  kompetenzen: [
    { id: "Fa1",  feld: "fa", name: { de: "Fachwissen", en: "Disciplinary knowledge" } },
    { id: "Fa2",  feld: "fa", name: { de: "Forschungsmethoden & Design", en: "Research methods & design" } },
    { id: "Fa3",  feld: "fa", name: { de: "Statistik, R & Daten", en: "Statistics, R & data" } },
    { id: "Fa4",  feld: "fa", name: { de: "wissenschaftliches/kritisches Denken", en: "Scientific/critical thinking" } },
    { id: "Fa5",  feld: "fa", name: { de: "Diagnostik, Testtheorie & Assessment", en: "Diagnostics, test theory & assessment" } },
    { id: "Fa6",  feld: "fa", name: { de: "Schreiben & Kommunikation", en: "Writing & communication" } },
    { id: "Fa7",  feld: "fa", name: { de: "Ethik & Integrität", en: "Ethics & integrity" } },
    { id: "Fa8",  feld: "fa", name: { de: "evidenzbasierte Praxis/Transfer", en: "Evidence-based practice/transfer" } },
    { id: "Fa9",  feld: "fa", name: { de: "Diversität & Kontext", en: "Diversity & context" } },
    { id: "Fa10", feld: "fa", name: { de: "Selbstmanagement", en: "Self-management" } },
    { id: "KI1",  feld: "ki", name: { de: "Anwenden", en: "Applying" } },
    { id: "KI2",  feld: "ki", name: { de: "Gestalten", en: "Creating" } },
    { id: "KI3",  feld: "ki", name: { de: "Zusammenarbeiten", en: "Collaborating" } },
    { id: "KI4",  feld: "ki", name: { de: "Verstehen", en: "Understanding" } },
    { id: "KI5",  feld: "ki", name: { de: "Verantworten", en: "Taking responsibility" } },
    { id: "KI6",  feld: "ki", name: { de: "Evaluieren", en: "Evaluating" } },
    { id: "Fu1",  feld: "fu", name: { de: "Arbeiten/Gestalten (mit und ohne KI)", en: "Working/creating (with & without AI)" } },
    { id: "Fu2",  feld: "fu", name: { de: "Persönliche Fähigkeiten", en: "Personal capabilities" } },
    { id: "Fu3",  feld: "fu", name: { de: "Soziales Umfeld gestalten", en: "Shaping the social environment" } }
  ],
