...
window.QUIZ = {
 ...
 "06SM200-BA": [
  ...
  {
   "q": {
    "de": "Beim Erstellen des AI Use Plans für die Bachelorarbeit (Kategorie A+B) ordnet eine Studentin ihre fünf Arbeitsschritte den Modi zu. Welche Zuordnung entspricht der Prüfungslogik?",
    "en": "When drafting the AI Use Plan for the bachelor's thesis (category A+B), a student assigns her five work steps to the modes. Which assignment matches the assessment logic?"
   },
   "a": [
    {
     "de": "Die Verteidigung der methodischen Kernentscheidungen als [A]; das Literatur-Screening als [B] mit Disclosure, Prozesslog und Verifikationsschritt.",
     "en": "Defending the core methodological decisions as [A]; literature screening as [B] with disclosure, process log and a verification step."
    },
    {
     "de": "Die Verteidigung der methodischen Kernentscheidungen als [B]; das Literatur-Screening als [A], weil die Recherche das Fundament der Arbeit bildet.",
     "en": "Defending the core methodological decisions as [B]; literature screening as [A], because the search forms the foundation of the thesis."
    },
    {
     "de": "Alle fünf Arbeitsschritte als [B], weil die Kategorie A+B durchgängig assistiertes Arbeiten mit einem einzigen Sammellog am Schluss erlaubt.",
     "en": "All five work steps as [B], because category A+B permits consistently assisted work with one single summary log at the end."
    },
    {
     "de": "Alle fünf Arbeitsschritte als [A], weil KI-Nutzung in einer Qualifikationsarbeit mit der Eigenständigkeitserklärung kollidieren würde.",
     "en": "All five work steps as [A], because AI use in a qualification thesis would conflict with the declaration of independent work."
    }
   ],
   "korrekt": 0,
   "erkl": {
    "de": "Die Kategorie A+B kombiniert KI-freie Kernschritte mit assistierten Schritten: Die Verteidigung der methodischen Kernentscheidungen sichert als [A] die zertifizierte Kompetenz, das Literatur-Screening läuft als [B] mit Disclosure, Prozesslog und Verifikation pro Schritt. Die Umkehrung ist verführerisch, weil die Recherche fundamental erscheint; der Deskilling-Schutz gilt aber den Fertigkeiten, welche die Arbeit nachweisen soll, nicht dem gut delegierbaren Screening.",
    "en": "Category A+B combines AI-free core steps with assisted steps: defending the core methodological decisions secures the certified competence as [A], while literature screening runs as [B] with disclosure, a process log and per-step verification. The reversal is seductive because the search seems foundational; deskilling protection, however, targets the skills the thesis is meant to certify, not the readily delegable screening."
   }
  }
 ],
 "06SM200-500": [
